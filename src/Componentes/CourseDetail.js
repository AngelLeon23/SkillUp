            ...
            {isEnrolled ? (
              <div className="mb-4">
                ...
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    className={`h-3 rounded-full transition-all ${progress === 100 ? 'bg-green-500' : 'bg-green-600'}`}
              ...
              <button
                onClick={onEnroll}
                className="w-full py-3 bg-green-700 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors text-lg"
              >
            ...
            <div key={module.id} className="border border-gray-200 rounded-lg overflow-hidden">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <svg
                    className={`w-5 h-5 text-gray-500 transition-transform ${expandedModule === module.id ? 'rotate-180' : ''}`}
